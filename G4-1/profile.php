...
<body>
    ...
    try {
        ...
        if ($user) {
            ...
            echo '<div class="profile_head_icon"><span><img src="../images/guest.png"></span></div>';
            // ', htmlspecialchars($user['icon'] ?? ''), '
            ...
            if ($posts) {
                ...
                foreach ($posts as $post) {
                    ...
                    echo '<img src="../images/indian.png">';
                    echo '</a>';
                    // ', htmlspecialchars($post['image_name'] ?? ''), '
                }
                echo '</div>';
            } else {
                echo '投稿がありません';
